...
_Related_: Loaded MPS Repository, source repository, checkout
...
**Loaded MPS Repository**:
The complete MPS repository visible to a loaded MPS session, including **Project Modules** and loaded dependency or platform modules.
_Avoid_: repository when ambiguous
_Related_: Git repository, source repository

**Project Contents**:
The set of **Project Modules** owned by an **MPS Project**.
_Related_: Loaded MPS Repository
...
**Reference Link**:
An **MPS Link** that points to another **MPS Node** without owning it.
...
Domain expert: No. MPS.Core may be visible in the **Loaded MPS Repository**, but it is not a **Project Module** owned by the **MPS Project**.

Dev: What should a project-level listing show?

Domain expert: It should show **Project Contents**: the **Project Modules** owned by the **MPS Project**.
